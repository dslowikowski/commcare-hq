...
class ProductApiTest(TestCase):
    ...
    def testParseWebUserJSON(self):
        ...
        self.assertEqual(webuser.password, "sha1$4afa5$ae4f24ff81a768f14dd552be204058f34756c8d7")
    ...
    def testParseSMSUserJSON(self):
        ...
        self.assertEqual(smsuser.name, "Melania Nkaka")
        self.assertEqual(smsuser.role, "ic")
        self.assertEqual(smsuser.supply_point, 79)
        self.assertEqual(smsuser.email, "nkaka@gmail.com")
