...
BELOW_REORDER_LEVELS = 'Dear Name, the following commodities are at or below re-order level at the Shai Osudoku District Hospital. (indicate the list of commodities, eg. Jadelle, Micro-G, Male Condom; overstocked Microlut, Copper-T)'
ABOVE_THRESHOLD = 'Dear Name, these items are overstocked: (indicate name of commodity). The district admin has been informed.'
WITHOUT_RECEIPTS = 'Error! You submitted increases in stock levels of (indicate the list of commodities, eg. first reponse, male condom, microgynon, etc) without corresponding receipts.  Please contact your DHIO or RHIO for assistance.'
